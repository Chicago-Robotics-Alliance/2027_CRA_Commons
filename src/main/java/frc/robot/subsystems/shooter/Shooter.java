...
public class Shooter extends FlywheelMotorSubsystem<MotorIOSpark> {
  ...
  public static final Setpoint CLOSE_SHOT = Setpoint.withVelocitySetpoint(ShooterConstants.kCloseShotRPM);
  public static final Setpoint MEDIUM_SHOT = Setpoint.withVelocitySetpoint(ShooterConstants.kMediumShotRPM);
  public static final Setpoint FAR_SHOT = Setpoint.withVelocitySetpoint(ShooterConstants.kFarShotRPM);
