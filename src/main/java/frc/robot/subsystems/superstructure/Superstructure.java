...
public class Superstructure extends SubsystemBase {
  ...
  // Returns a command that spins up the shooter to the close setpoint, then enables the
  // indexer/intake when the shooter is spun up
  public Command closeShot() {
    return Shooter.mInstance
        .followSetpointCommand(() -> Shooter.CLOSE_SHOT)
  ...
  // Returns a command that spins up the shooter to the medium setpoint, then enables the
  // indexer/intake when the shooter is spun up
  public Command mediumShot() {
    return Shooter.mInstance
        .followSetpointCommand(() -> Shooter.MEDIUM_SHOT)
        .until(Shooter.mInstance::spunUp)
        .andThen(
            Commands.parallel(
  ...
  // Returns a command that spins up the shooter to the far setpoint, then enables the
  // indexer/intake when the shooter is spun up
  public Command farShot() {
    return Shooter.mInstance
        .followSetpointCommand(() -> Shooter.FAR_SHOT)
        .until(Shooter.mInstance::spunUp)
        .andThen(
            Commands.parallel(
