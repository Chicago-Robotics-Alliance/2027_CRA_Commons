...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    driveConfig
        ...
        .primaryEncoderPositionPeriodMs((int) (1000.0 / DriveBase.ODOMETRY_FREQUENCY))
    ...
    turnConfig
        ...
        .absoluteEncoderPositionPeriodMs((int) (1000.0 / DriveBase.ODOMETRY_FREQUENCY))
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnEncoderConnected = inputs.turnConnected;
